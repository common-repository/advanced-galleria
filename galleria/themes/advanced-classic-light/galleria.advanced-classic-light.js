/**
 * Advanced Classic Theme (Light) 2013-06-06
 * http://amwhalen.com
 *
...
Galleria.addTheme({
    name: 'advanced-classic-light',
    author: 'Andy Whalen',
    css: 'galleria.advanced-classic-light.min.css',
    defaults: {
    ...
    init: function(options) {
        ...
        Galleria.requires(1.28, 'This version of advanced Classic Light theme requires Galleria 1.2.8 or later');
